...
"""Module to generate Iris dataset for using in custom TPUEstimator. & An Example of a custom TPUEstimator for the Iris dataset."""
...
def main(argv):
    ...
    # Evaluate the model.
   #not supported for TPU pods - evaluation and predictions should be done on single TPUs
